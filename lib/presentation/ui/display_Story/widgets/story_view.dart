...
class StoryItem {
  ...
  factory StoryItem.pageImage({
    required String url,
    required DisplayStoryController controller,
    Key? key,
...
class StoryView extends StatefulWidget {
  ...
  final DisplayStoryController controller;
...
class StoryViewState extends State<StoryView> with TickerProviderStateMixin {
  ...
  Widget get _currentView => widget.storyItems.firstWhere((it) => !it!.shown, orElse: () => widget.storyItems.last)!
      .view;
